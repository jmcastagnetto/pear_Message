 ...
 * @package Message
 */
class Message_HMAC_HAVAL256 extends Message_HMAC_Common {/*{{{*/

	/**
	 * Constructor for the class Message_HMAC_HAVAL256
	 *
	 ...
	 * @return object Message_HMAC_HAVAL256
	 * @access public
	 */
	function Message_HMAC_HAVAL256($key, $ser = '', $enc = '') {/*{{{*/
		$this->Message_HMAC_Common('MHASH_HAVAL256', $key, $ser, $enc);
	}/*}}}*/
}/*}}}*/
