...
/**
 * Wrapper class for HMAC signature calculation and validation using the SHA1 algorithm
 * @author  Jesus M. Castagnetto
 * @version 0.6
 * @access  public
 * @package Message
 */
class Message_HMAC_SHA1 extends Message_HMAC_Common {/*{{{*/
	 ...
	 * @return object Message_HMAC_SHA1
	 * @access public
	 */
	function Message_HMAC_SHA1($key, $ser = '', $enc = '') {/*{{{*/
		$this->Message_HMAC_Common('MHASH_SHA1', $key, $ser, $enc);
	}/*}}}*/
}/*}}}*/
