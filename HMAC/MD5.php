 ...
 * @package Message
 */
class Message_HMAC_MD5 extends Message_HMAC_Common {/*{{{*/
	 ...
	 * @return object Message_HMAC_MD5
	 * @access public
	 */
	function Message_HMAC_MD5($key, $ser = '', $enc = '') {/*{{{*/
		$this->Message_HMAC_Common('MHASH_MD5', $key, $ser, $enc);
	}/*}}}*/
}/*}}}*/
