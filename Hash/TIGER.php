 ...
 * @package Message
 */
class Message_Hash_TIGER extends Message_Hash_Common {/*{{{*/

	/**
	 * Constructor for the class Message_Hash_TIGER
	 *
	 ...
	 * @return object Message_Hash_TIGER
	 * @access public
	 */
	function Message_Hash_TIGER($ser = '', $enc = '') {/*{{{*/
		$this->Message_Hash_Common('MHASH_TIGER', $ser, $enc);
	}/*}}}*/
}/*}}}*/
