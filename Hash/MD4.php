 ...
 * @package Message
 */
class Message_Hash_MD4 extends Message_Hash_Common {/*{{{*/

	/**
	 * Constructor for the class Message_Hash_MD4
	 *
	 ...
	 * @return object Message_Hash_MD4
	 * @access public
	 */
	function Message_Hash_MD4($ser = '', $enc = '') {/*{{{*/
		$this->Message_Hash_Common('MHASH_MD4', $ser, $enc);
	}/*}}}*/
}/*}}}*/
