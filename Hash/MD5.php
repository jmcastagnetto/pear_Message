 ...
 * @package Message
 */
class Message_Hash_MD5 extends Message_Hash_Common {/*{{{*/

	/**
	 * Constructor for the class Message_Hash_MD5
	 *
	 ...
	 * @return object Message_Hash_MD5
	 * @access public
	 */
	function Message_Hash_MD5($ser = '', $enc = '') {/*{{{*/
		$this->Message_Hash_Common('MHASH_MD5', $ser, $enc);
	}/*}}}*/
}/*}}}*/
